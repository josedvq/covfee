...
A covfee project may contain one or multiple different HITs. A JSON file is the easiest way to specify your covfee project. You can find examples of such JSON files in the samples folder in github.
