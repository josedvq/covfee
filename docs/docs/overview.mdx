...
For a step-by-step guide on how to work with covfee see [Getting Started](getting_started)
...
- **Support for consent forms and rich instructions** *Instructions* tasks can be used to provide detailed instructions in Markdown/HTML (including videos) and set up subject consent forms (see [Instructions Task](tasks/instructions)).
- **Forms support** *Questionnaire* tasks can be used to request non-continuous feedback from participants via text boxes, buttons, sliders, and more (see [Questionnaire Task](tasks/questionnaire)).
...
See [Custom Tasks](custom_task) for a step-by-step guide on how to write your custom tasks in covfee.
