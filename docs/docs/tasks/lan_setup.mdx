...
docker run -p 4443:4443 --rm -e DOMAIN_OR_PUBLIC_IP=192.168.0.22 -e OPENVIDU_SECRET=MY_SECRET -e OPENVIDU_RECORDING=true -e OPENVIDU_RECORDING_PATH=/mnt/recordings -v /var/run/docker.sock:/var/run/docker.sock -v "E:\openvidu_recordings:/mnt/recordings" openvidu/openvidu-dev:2.29.0

## Check portproxy

netsh interface portproxy show all

RUN in WSL or Linux environment with:

docker run -p 4443:4443 --rm -e DOMAIN_OR_PUBLIC_IP=192.168.0.22 \
