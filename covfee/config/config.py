...
class Config(flask.Config):
    ...
    def load_environment(self, mode: str):
        ...
        self['SSL_ENABLED'] = (
            'SSL_KEY_FILE' in self and 'SSL_CERT_FILE' in self)
        ...
        self.update(
            ...
            # create derived URLs
            PROJECT_WWW_URL=self.get(
                'PROJECT_WWW_URL', self['BASE_URL'] + '/www'),
    ...
    def get_frontend_config(self):
        ...
        return {
            ...
            'env': 'production' if self['COVFEE_ENV'] in ['local', 'deploy'] else 'development',
